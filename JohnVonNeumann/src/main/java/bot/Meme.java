...
public class Meme {
	...
	public void mostrarMeme(String nombreMeme) {// el asistente deberia llamar el metodo pasandome el nombre del meme.
		...
		map.put("puta que oferton",
				"https://cdn.dopl3r.com/memes_files/puta-que-oferton-memegenes-b6H6t.jpg");
		map.put("khea",
				"https://pbs.twimg.com/media/DXiviVIW0AUcRE8.jpg");
		map.put("nigga cry", "https://4.bp.blogspot.com/-7Sak9jnYW2I/UJrUjN3ozPI/AAAAAAAAAYY/DKoeELbg-4o/s400/negro+llora.jpg");
		map.put("no lo se rick",
				"http://wikinoticias.mx/wp-content/uploads/2017/11/parece-falso-1.jpg");
		map.put("porque eres asi",
				"https://pbs.twimg.com/media/Cur7IWZWgAAVbrf.jpg");
		...
		map.put("no ahora por favor",
				"https://pm1.narvii.com/6198/2e2b4399e5067b59e732296ca3815ed717f3501e_hq.jpg");
		map.put("ponte verga",
