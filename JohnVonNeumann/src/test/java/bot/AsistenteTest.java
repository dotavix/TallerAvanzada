...
public class AsistenteTest {
	...
	public void ejercicio01() throws Exception {
		...
		String[] mensajes = { "hola!", "hola padre, como andas" };
	...
	public void ejercicio02() throws Exception {
		...
		String[] mensajes = { "gracias, te agradezco mucho por lo que hiciste!", "GRAciaS!" };
	...
	public void ejercicio04() throws Exception {
		...
		Assert.assertTrue(
				robot.enviar(USER, "cuantos dias faltan para el 4 de septiembre de 2018??").contains("Falta"));
		...
		Assert.assertTrue(
				robot.enviar(USER, "cuantos meses faltan para el 4 de septiembre de 2018??").contains("Falta"));
		...
		Assert.assertTrue(
				robot.enviar(USER, "cuantos años faltan para el 4 de septiembre de 2023??").contains("Falta"));
	...
	public void ejercicio17() throws Exception {
		...
		Assert.assertTrue(robot.enviar(USER, "quiero las noticias actuales porque soy muy intelectual")
				.contains("---NOTICIAS---"));
